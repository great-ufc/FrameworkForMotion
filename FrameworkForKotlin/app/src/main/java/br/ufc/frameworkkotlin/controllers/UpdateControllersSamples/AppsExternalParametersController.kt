package br.ufc.frameworkkotlin.controllers.UpdateControllersSamples
        ...
        params.forEach { (key, value) ->
            ...
            when(key){
                "current_version" -> {
                    ...
                    val localVersionNumber = convertVersion(br.ufc.frameworkkotlin.BuildConfig.VERSION_NAME)
