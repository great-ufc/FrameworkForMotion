...
class DataController {
    ...
    private val TAG = br.ufc.frameworkkotlin.controllers.DataController::class.java.simpleName
    ...
    fun checkAttrsFilled(): Boolean {
        return br.ufc.frameworkkotlin.controllers.DataController.Companion.NUM_ATTRS == attrsFilled
    }
