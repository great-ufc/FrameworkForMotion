...
import br.ufc.frameworkkotlin.model.GoogleFit.Samples.GoogleFitStepData
...
class MainActivity : BaseActivity(),SensorEventListener {
    ...
    private lateinit var dbPessoa: PessoaRepository
    //------Generated by the Framework and must not be changed-----//
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonChangeBattery.setOnClickListener{
            ...
            runOnUiThread {
                Log.i("Result", "Value Battery: "+ this.energy )
            }
        }
