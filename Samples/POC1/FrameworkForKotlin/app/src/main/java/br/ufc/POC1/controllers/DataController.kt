...
class DataController {
    ...
    private val TAG = br.ufc.POC1.controllers.DataController::class.java.simpleName
    ...
    fun checkAttrsFilled(): Boolean {
        return br.ufc.POC1.controllers.DataController.Companion.NUM_ATTRS == attrsFilled
    }
