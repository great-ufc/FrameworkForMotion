...
package br.ufc.POC1.model.mapek.monitoring

import br.ufc.POC1.model.mapek.monitoring.GoogleFit.Samples.GoogleFitGetAllData
import br.ufc.POC1.model.entities.sensors.ValuesSensor
import br.ufc.POC1.model.entities.sensors.typeSensor
import br.ufc.POC1.model.mapek.observer.*
...
class DataManagement(val context: BaseActivity):IMonitorObservable,IExecutionObserver {
    ...
    fun Monitoring(){
        ...
        while (System.currentTimeMillis() < this.dataCollectTime+(Constants.WINDOW*(100).toLong())) {
            ...
            context.dataController = br.ufc.POC1.controllers.DataController()
